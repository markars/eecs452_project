...
##
fish = pygame.image.load("images/fish.jpg")
shark = pygame.image.load("images/shark.jpg")
eraser = pygame.image.load("images/eraser.jpg")
fish_button_1 = pygame.transform.scale(fish, (40, 40))
fish_button_2 = pygame.transform.scale(shark, (40, 40))
eraser = pygame.transform.scale(eraser, (40,30))
